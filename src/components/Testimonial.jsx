            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-14 place-items-center">
                <div className="space-y-5 lg:max-w-[-400px]">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        initial="hidden"
                        whileInView="show"
                        src="https://picsum.photos/id/237/200/300" alt="img"
                        ...
                        className="flex flex-col items-center space-y-1">
                            <h2 className="text-xl font-bold">Juanes Salazar</h2>
                ...
                <div className="relative">
                    ...
                    src={BannerPng} alt="Banner" className="relative z-10 w-full lg:max-w-[280px] img-shadow"/>
                    <motion.div 
                    initial={{ opacity:0 }}
